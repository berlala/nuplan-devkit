...
class SPEED_DP_DECIDER_v1:
    ...
    def __init__(self, 
        ...
        for object in objects:
            # 注意障碍物类别的有效性
            if object.tracked_object_type is TrackedObjectType.VEHICLE and len(object.predictions)>0:
    ...
    def dynamic_programming(self) ->Tuple[float]:
        ...
        # # 构造文件名，包括路径、文件名和后缀
        # file_name = f'/home/bolin/Projects/shenlan/nuplan-devkit/nuplan/planning/simulation/planner/project2/plot_test/ST_DP_RES_{current_time_str}.png'
        ...
        # 设置文件名前缀和扩展名
        file_name_prefix = "/home/bolin/Projects/shenlan/nuplan-devkit/nuplan/planning/simulation/planner/project2/test_fig_ST_DP"
        file_extension = ".png"
